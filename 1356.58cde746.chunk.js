"use strict";(self.webpackChunkphotoland=self.webpackChunkphotoland||[]).push([[1356],{81356:(H,T,t)=>{t.d(T,{ProtectedListPage:()=>gt});var s=t(92132),g=t(21272),x=t(11273),M=t(42455),C=t(38413),S=t(55356),W=t(74773),c=t(30893),i=t(85963),o=t(4198),h=t(94061),r=t(35513),f=t(40216),B=t(26127),D=t(90361),l=t(33363),L=t(50215),_=t(98765),tt=t(25641),O=t(83997),V=t(63891);const I=V.Ay.div`
...
`,c=(0,g.Ay)(x.a)`
  ...
  width: 100%;
  border: none;
`,i=({children:o,icon:h,...r})=>(0,s.jsxs)("div",{children:[(0,s.jsx)(M.c,{}),(0,s.jsx)(c,{as:"button",background:"primary100",padding:5,...r,children:(0,s.jsxs)(C.s,{children:[(0,s.jsx)(W,{"aria-hidden":!0,background:"primary200",children:h}),(0,s.jsx)(x.a,{paddingLeft:3,children:(0,s.jsx)(S.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:o})})]})})]})}}]);
