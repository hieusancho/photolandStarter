...
const MainSlider = () => {
  return <Swiper modules={[Pagination]} loop={true}    
                ...
                className='mainSlider h-full bg-primary xl:bg-mainSlider xl:bg-no-repeat max-w-lg lg:max-w-none rounded-[8px]
                ...
                return <SwiperSlide key={index}>
                          <div className='flex flex-col lg:flex-row h-full p-[20px] md:p-[60px] '>
                            ...
                            <div className='w-full lg:flex-1 '>
                              ...
                              <div className='text-3xl md:text-[46px] font-semibold uppercase leading-none text-center 
                                              lg:text-left mb-8 xl:mb-20'>
                                {slide.titlePart1} <br/>
                                {slide.titlePart2} <br/>
                                {slide.titlePart3} 
                              </div>
